...
// FormatSpectreHub is the SpectreHub envelope output format.
const FormatSpectreHub Format = "spectrehub"
...
func HashURI(rawURI string) string {
	...
	if err != nil {
		// If unparseable, hash the whole thing.
...
func writeSpectreHub(w io.Writer, report *Report) error {
	...
	// Ensure findings array is never null in JSON.
